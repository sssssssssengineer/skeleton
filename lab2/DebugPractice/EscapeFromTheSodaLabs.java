public class EscapeFromTheSodaLabs extends Trial {
    ...
    public static void main(String[] args) {
        /**
         * Press F8 when met with treasureChest
         * Press F7 when met with trap/superTrap
         * Press Shift+F8 after treasureChest was met inside a trap to step out the trap/superTrap method
         */
