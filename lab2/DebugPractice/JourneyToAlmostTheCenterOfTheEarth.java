public class JourneyToAlmostTheCenterOfTheEarth extends Trial {
    ...
    public static void main(String[] args) {
        /**
         * Set a breakpoint at 1st line of main, then press F7 when met with digForTreasure method,
         * because we need to step into the method to dig treasure;
         * When met with fallToCenterOfTheEarth, press F8 to skip it, in case that Cal falls
         */
